...
class WP_Optimize_Images_Trash_Manager_Commands extends Updraft_Task_Manager_Commands_1_0 {
	...
	public function move_images_to_trash($data) {
		...
		$message = sprintf(__('%s of %s selected images were successfully moved to the trash', 'wp-optimize'), $success_count, $total_count);
	...
	public function restore_images_from_trash($data) {
		...
		$message = sprintf(__('%s of %s selected images were successfully restored from the trash', 'wp-optimize'), $success_count, $total_count);
	...
	public function remove_trash_images($data) {
		...
		$message = sprintf(__('%s of %s selected images were permanently removed from trash', 'wp-optimize'), $success_count, $total_count);
